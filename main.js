...
const spaceTexture = new THREE.TextureLoader().load('jupiter.jpeg');
...
const self = new THREE.TextureLoader().load('sub1mbPic.jpg');

const matt = new THREE.Mesh(
    new THREE.BoxGeometry(5, 5, 5),
    new THREE.MeshBasicMaterial({map:self})
);

scene.add(matt);

const moonTxt = new THREE.TextureLoader().load('moonTxt.jpeg');
